...
function love.load()
  ...
  cityBorder = 20
  cityWidth = width - (2*cityBorder) - ((numCitiesW-1)*cityBorder)
  cityHeight = height - (2*cityBorder) - ((numCitiesH-1)*cityBorder)
  ...
  for i = 1, numCitiesH do    -- make cities
    for j = 1, numCitiesW do
      local city = {}
